				...
				<div class = "container">
					...
					<div class = "row">
						<div class = "col-md-6 col-sm-12">
							<div id="about-text">
								<p>The Arches Project has been founded with the sight <a href="<?php echo home_url();?>/artist-directory">to be a platform</a> for creative talents of all discipline.</p>
								<p>
