...
if ( !class_exists( 'EPL_Form_Manager' ) ) {
    ...
    class EPL_Form_Manager extends EPL_Controller {
        ...
        function _fields_page( $for = 'epl_fields' ) {
            ...
            //field creation form
            $data['events_planner_field_form'] = $this->epl_util->render_fields( $field_args );
        ...
        function _field_choices( $for = 'epl_fields', $values = array( ) ) {
            ...
            $data['field_choices_form'] = $this->epl_util->render_fields( $field_args );
        ...
        function _forms_page( $for = 'epl_forms' ) {
            ...
            $data['events_planner_forms_form'] = $this->epl_util->render_fields( $field_args );
