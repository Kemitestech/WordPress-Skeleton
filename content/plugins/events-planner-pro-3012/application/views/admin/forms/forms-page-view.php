...
<form id ="<?php echo $scope ;?>_form" action="<?php echo epl_get_url(); ?>" method="post" class="epl_ajax_form">
                        ...
                        <td colspan="2">
                            <div id="form_field_list">
                                <div style="padding:10px;">
                                    <a href="#" id="<?php echo $included_fields ;?>" class="epl_button epl_field_list button-secondary">Click here to select fields</a>
                                </div>
