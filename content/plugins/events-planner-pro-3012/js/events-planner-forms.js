jQuery(document).ready(function($){
    ...
    //a div is required after each field for farbtastic to work for multiple inputs
    $('.pick_color').click( function(e) {
        var color_picker = jQuery(this).next('div.epl_color_picker');
        var input = jQuery(this).prev('input');
        var pos = $(input).position();

        color_picker.css('left', pos.left);
        color_picker.farbtastic(input);
    ...
    $('body').on('blud', '#epl_field_slug, #epl_form_slug, .input_name, .make_slug', function(){
        var me = $(this);
    ...
    $('body').on('change', 'select.epl_field_type', function(){
    ...
    $('body').on('click', '.epl_action', function(){
        ...
        if (me.hasClass('epl_delete')){
            ...
            _EPL.delete_element({                
                ...
                par: par,
                action: a,
                force: me.hasClass('force_delete')
            });
            return false;
        }
    ...
    $('body').on('click', 'a.cancel_edit', function(){
    ...
    $('form#epl_fields_form, form#epl_forms_form, form#epl_payment_profile_fields_form').submit(function(){
        ...
        events_planner_do_ajax( data, function(r){
            ...
            if ( mode == 'edit' ){
                ...
                if (_row_id == undefined)
                    _row_id = $('input[name="input_name"]', me).val();
    ...
    $('body').on('click', '.add_table_row', function(){
    ...
    $('body').on('click', 'a.delete_table_row', function(){
    ...
    $('body').on('click', 'table.list_of_fields_for_forms tbody td div.epl_action', function(){
        var me = $(this);
    ...
    $('body').on('click', 'a.epl_field_list', function(){
